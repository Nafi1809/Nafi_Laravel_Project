    ...
    <div class="container mx-auto p-4">
        <nav class="flex justify-between items-center bg-white p-4 shadow-md rounded-lg">
            ...
            <ul class="flex space-x-6">
                <li><a href="#" class="text-gray-700 hover:text-red-500">Homepage</a></li>
                <li><a href="#" class="text-gray-700 hover:text-red-500">About me</a></li>
                <li><a href="#" class="text-gray-700 hover:text-red-500">Data</a></li>
                <li><a href="#" class="text-gray-700 hover:text-red-500">Gallery</a></li>
                <li><a href="#" class="text-gray-700 hover:text-red-500">Contact</a></li>
                <li><a href="{{ route('login') }}" class="text-red-500 hover:text-red-900 text-sm">Login Page?</a></li>
            </ul>
        </nav>
    </div>
        ...
        <div class="content-container flex flex-col items-center md:flex-row space-y-6 md:space-y-0 md:space-x-8">
            ...
            <div class="text-container text-center md:text-left">
                ...
                <div class="button mt-6">
                    <a href="{{ route('about') }}" class="bg-red-500 text-white px-6 py-2 rounded-full hover:bg-red-700 transition duration-300 ease-in-out">Explore Here!</a>
                </div>
            </div>
        </div>
    </div>
